...
export async function handler(event) {
	...
	const expirationDate = event.Details.ContactData.Attributes.ExpirationDate;
	if (!expirationDate || expirationDate.length < 1) {
		console.error('ExpirationDate was not found in contact attributes.');
		throw new Error('ExpirationDate was not found in contact attributes.');
	}
